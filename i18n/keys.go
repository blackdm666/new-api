...
const (
	...
	MsgHumanVerificationRequired     = "human_verification.required"
	MsgHumanVerificationFailed       = "human_verification.failed"
	MsgHumanVerificationUnavailable  = "human_verification.unavailable"
