...
func uniqueChannelAffinityStatsTestKey(prefix string) string {
	return fmt.Sprintf("%s_%d", prefix, channelAffinityStatsTestSequence.Add(1))
}
...
func TestObserveChannelAffinityUsageCacheByRelayFormat_ClaudeMode(t *testing.T) {
	ruleName := uniqueChannelAffinityStatsTestKey("rule")
	usingGroup := "default"
	keyFP := uniqueChannelAffinityStatsTestKey("fp")
