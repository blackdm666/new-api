...
const (
	...
	VerificationScopeChannelBalanceTokenRead = "channel.balance_token.read"
...
func BindVerificationOperation(operation VerificationOperation) (VerificationBinding, error) {
	...
	case VerificationScopeChannelKeyRead, VerificationScopeChannelBalanceTokenRead:
...
func securityVerificationPolicy(scope string, state model.UserVerificationState) ([]VerificationMethodOption, error) {
	...
	switch scope {
	case VerificationScopeChannelKeyRead, VerificationScopeChannelBalanceTokenRead, VerificationScopePasskeyDelete, VerificationScopeLogin:
...
func GetVerificationRequirements(identity AuthIdentity, scope string) (*VerificationRequirements, error) {
	...
	if (scope == VerificationScopeChannelKeyRead || scope == VerificationScopeChannelBalanceTokenRead) && state.Role != common.RoleRootUser {
		return nil, ErrVerificationForbidden
	}
