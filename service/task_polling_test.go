...
func (a *terminalVideoPollingAdaptor) FetchTask(_ string, _ string, task *model.Task, _ string) (*http.Response, error) {
...
func (a *terminalVideoPollingAdaptor) ParseTaskResult(*model.Task, *http.Response, []byte) (*relaycommon.TaskInfo, error) {
	return nil, nil
}
