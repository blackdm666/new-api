...
const defaultBillingSettings: BillingSettings = {
  ...
  CreemProducts: '[]',
  AntomEnabled: false,
  AntomDisplayName: 'Global Wallet Payment',
  AntomGateway: 'https://open-sea-global.alipay.com',
  AntomClientId: '',
  AntomMerchantPrivateKey: '',
  AntomPublicKey: '',
  AntomMerchantPrivateKeyConfigured: false,
  AntomPublicKeyConfigured: false,
  AntomNotifyURL: '',
  AntomRedirectURL: '',
  WaffoEnabled: false,
  WaffoApiKey: '',
