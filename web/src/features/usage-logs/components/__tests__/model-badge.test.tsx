...
it.each(
  ...
  async ({ model, category, label }) => {
    ...
    if (model.toLowerCase().includes('codex')) expectedLabel = 'Codex'
    if (/seedance|seedream|seededit/i.test(model)) expectedLabel = 'Seedance'
