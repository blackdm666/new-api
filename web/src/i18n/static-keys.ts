...
export const STATIC_I18N_KEYS = [
  ...
  'Reset channel cumulative usage?',
  ...
  'Vertex trial credit activation steps',
  ...
  'BigQuery project ID',
  'BigQuery dataset ID',
  'Vertex credential channel ID',
  'Leave blank to reuse this channel JSON',
  'Use another Vertex channel ID only when that service account has the BigQuery permissions.',
  'Trial credit total',
  'Historical used baseline',
  'Tracking baseline time',
  'Only promotional credits with usage after this time are added to the historical baseline, preventing double counting.',
  'Expected billing table',
  'Complete the billing account, project, and dataset fields.',
  'BigQuery billing table: {{table}}',
  'Custom mapping',
  'Configure the request path, authentication, and JSON response fields.',
  ...
  'NewAPI account balance',
  'OneAPI account access token required',
  'Select NewAPI compatible and enter an account access token. A normal channel API key only exposes that key quota, not the account wallet balance.',
  ...
  'Use {api_key} to insert the channel key.',
  'Response mapping',
  'Use dotted JSON paths such as data.balance.',
  'Remaining balance path',
  'Total path',
  'Used path',
  'Currency path',
  'Active status path',
  'Unlimited status path',
  'Balance unit',
  'Money',
  'Credits',
  'Tokens',
  ...
  'Existing channel adapter',
  'This channel type will continue using its existing built-in balance query behavior.',
  'Configuration incomplete',
  'Balance query path must start with a single slash',
  'Balance query URL is required',
  'Balance query URL must be an absolute HTTP or HTTPS URL',
  'Remaining balance JSON path is required',
  'Balance multiplier must be a positive number',
  'Authentication name is required',
  'Authentication value is required',
  'Account access token is required; the channel API key cannot read the account wallet balance',
  ...
  'BigQuery dataset ID is invalid',
  'Vertex credential channel ID must be a positive integer',
  'Trial credit total must be a positive number',
  'Historical used baseline must be between zero and the total',
  'Tracking baseline time is required',
  'NewAPI account token required',
  'Sub2API built-in',
  ...
  'Users who have not signed in for the configured period.',
  ...
  'No repeat top-up for (days)',
  'Inactive for (days)',
  'Wait after registration (hours)',
  'Active API use within (days)',
  'Minimum successful API requests',
  'Minimum eligible top-ups',
  'Maximum sends per user',
  'Repeat interval (days)',
  'Announcement email validity (hours)',
  'Insert latest announcement',
  'Latest announcement inserted',
  'No published announcement available',
  'Latest announcement does not fit in the email content limit',
  'Preview email',
  'Draft',
  'Scheduled',
  'Running',
  ...
  'Campaign updated',
  'Campaign deleted',
  'Delete this completed campaign?',
  ...
  'SMTP host is required when a profile is configured',
  'Sender address or username is required when a profile is configured',
  'Security mail',
  'Notification mail',
  'Marketing mail',
  'Security mail profile',
  'Marketing mail profile',
  ...
  'Test and enable selected profile',
  'Configured',
  'Not configured',
  'Show full token',
  'Hide token',
  'Failed to fetch balance query token',
  'Balance query token unlocked',
  'Request method',
  'JSON request body',
  'The request body must be valid JSON. Use {api_key} to insert the channel key.',
  'Additional headers',
  'Up to 20 additional request headers are supported.',
  'Add header',
  'Additional header name',
  'Additional header value',
  'Configured; leave blank to keep the current value',
  'Header value or {api_key}',
  'Remove header',
  'Remaining balance calculation',
  'Read remaining field directly',
  'Total minus used or frozen',
  'Used or frozen path',
  'Success status path',
  'Expected success value',
  'Test query',
  'Testing...',
  'Balance query test failed',
  'Balance query test succeeded',
  'Balance query test needs attention',
  'Response mapping did not match',
  ...
  'Low balance administrator alert',
